    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <div className="mb-3 space-y-4">I began my career as a Backend Developer specializing in Spring Boot
            ...
            TypeScript, among others.</div>

            <div className="mb-3">Recognized for my quick learning capabilities, I progressively
            ...
            appreciate how TypeScript enhances code clarity and maintainability.</div>
            

            <div className="mb-3">In addition to programming, I have practical experience deploying
            applications using AWS, Docker, and Azure, and managing databases
            like MySQL, PostgreSQL, and MongoDB. I possess extensive knowledge of Firebase and Supabase, which I utilize for creating robust CRUD operations.</div>
          </motion.div>
          </div>
        </motion.div>
